...
$query = "SELECT * FROM prospective_student WHERE id = '$id1'";
...
if ($num != 0) {
	...
	$query = "INSERT INTO prospective_student (`username`, `id`, `email_id`, `pass`, `ph_no`) VALUES ('$uname1','$id1','$emailid1','$pass1','$phone1')";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (!preg_match($regex_name, $formData[0])) {
			...
			return $err;
				...
				$err = "Please fill out a phone number.";
				return $err;
}	
    else 
	{
