...
<head>
	...
	<title>Add Permanent Accommodation</title>
...
<body>
	...
	<div id="contents">
		<div class="background">
			...
			include 'C:/xampp/htdocs/ssdi_test1/script/add_permlisting.php';
		...
		//	echo $a;
			...
			function display_form()
			{
				...
				$query = "SELECT email_id from property_manager where id=$a";
				...
				<div style="background-color:#EEEEEE; width:500px; left:50px; float: left;padding-right:20px; height:700px; border-radius:5px;">
						<h2 style="color: #000099; text-align: center; font-family: Tahoma, Geneva, sans-serif;">Add Permanent Listing</h2>
						<table border="0" align="center" width = "100" style="font-family:georgia;font-size:15px;">
							...
							<tr>
								<td align="right" width="300" style="padding-right:5px">Price (in $):</td>
								<td width="100" align="left">
									<input id="hno" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Price" required = "true" /> 
								</td>
						    </tr>
							...
							<tr>
								...
								<td width="100" align="left">
									<input id="pm" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Your full name" required = "true" /> 
								</td>
						    </tr>
							<tr>
								<td align="right" width="300" style="padding-right:5px">Email ID:</td>
								<td width="100" align="left">
									<input id="pm" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" value="'; echo $email; echo '"required = "true" /> 
								</td>
						    </tr>
							<tr>
								<td align="right" width="300" style="padding-right:5px">Property Manager Address:</td>
								<td width="100" align="left">
									<input id="pm" style = "height:25px; padding-left:10px;border-radius:5px;" size = "50" type="text" name="f[]" placeholder="Property Manager Address" required = "true" /> 
								</td>
						    </tr>
							...
							<tr>
								...
								<td width="100" align="left">
									<input id="c_no" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Contact Number" required = "true" /> 
								</td>
						    </tr>
