...
include 'C:/xampp/htdocs/ssdi_test1/script/login_pm_script.php';
...
<div style="background-color:#EEEEEE; width:500px; left:500px; float: left;padding-right:20px; height:300px; border-radius:5px;">
						<h2 style="color: #000099; text-align: center; font-family: Tahoma, Geneva, sans-serif;">Property Manager LOGIN</h2>
						<table border="0" align="center" width = "458" style="font-family:georgia;font-size:15px;">
							...
							<tr>
								...
								<td align="left">
									<input id="emailed" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Your email" required = "true" />
								</td>
							</tr>
							<tr>
