...
include 'C:/xampp/htdocs/ssdi_test1/script/pm_signup.php';
...
<div style="background-color:#EEEEEE; width:500px; left:500px; float: left;padding-right:20px; height:300px; border-radius:5px;">
						<h2 style="color: #000099; text-align: center; font-family: Tahoma, Geneva, sans-serif;">Property Manager SIGNUP</h2>
						<table border="0" align="center" width = "458" style="font-family:georgia;font-size:15px;">
							...
							<tr>
								<td align="right" width="104" style="padding-right:5px">Email ID:</td>
								<td align="left">
