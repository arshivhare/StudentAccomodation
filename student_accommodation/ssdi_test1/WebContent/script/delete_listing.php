...
function del() {
	...
	$query = "SELECT * FROM permanent_acco WHERE house_no = '$house_no1'";
	...
	if ($num == 0) {
		...
		$query = "DELETE from permanent_acco where house_no = '$house_no1'";
...
public function check($formData){
	...
	global $house_no1;
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $query = "SELECT id FROM permanent_acco WHERE house_no = '$house_no1'"; 
            $result = mysqli_query($con,$query);
...
function display_view()
    ...
    global $a;
				...
				$query = "SELECT house_no,addr,zip_code,no_room,rent,dist,furnished,prop_manager,contact_no FROM permanent_acco  where id='$a'";
