...
include 'C:/xampp/htdocs/ssdi_test1/script/cur_signup.php';
...
<div style="background-color:#EEEEEE; width:500px; left:500px; float: left;padding-right:20px; height:300px; border-radius:5px;">
						<h2 style="color: #000099; text-align: center; font-family: Tahoma, Geneva, sans-serif;">Current Student SIGNUP</h2>
