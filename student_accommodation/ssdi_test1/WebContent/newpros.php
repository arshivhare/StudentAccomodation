...
include 'C:/xampp/htdocs/ssdi_test1/script/pros_signup.php';
...
<div style="background-color:#EEEEEE; width:500px; left:500px; float: left;padding-right:20px; height:300px; border-radius:5px;">
						<h2 style="color: #000099; text-align: center; font-family: Tahoma, Geneva, sans-serif;">Prospective Student SIGNUP</h2>
						<table border="0" align="center" width = "458" style="font-family:georgia;font-size:15px;">
							<tr>
								<td align="right" width="104" style="padding-right:5px">User Name:</td>
								<td width="318" align="left">
									<input id="uname" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Your Name" required = "true" /> 
								</td>
						  </tr>
							<tr>
								<td align="right" width="104" style="padding-right:5px">49er ID:</td>
								<td align="left">
									<input id="id" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Your 49er ID" required = "true"/>
								</td>
							</tr>
							<tr>
								<td align="right" width="104" style="padding-right:5px">49er Email ID:</td>
								<td align="left">
									<input id="emailed" style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="f[]" placeholder="Your mail id" required = "true" />
								</td>
							</tr>
							<tr>
